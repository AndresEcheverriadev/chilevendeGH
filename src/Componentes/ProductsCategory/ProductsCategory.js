        ...
        <div className="productsCategoryContainer">
          ...
          <div className='productsCategorySideBar'>
            <div className='sideBarElem filtersElem'>
              ...
              {existFilter === true ? <><button className='clearFiltersBtn' id='clearfilterBtn'  onClick={()=> clearFilters()}>Borrar filtros<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3 deleteItemIcon" viewBox="0 0 16 16">
